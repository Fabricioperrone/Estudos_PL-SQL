...
--
SELECT Sum(DESCONTO),
       Avg(DESCONTO),     -- considera colunas nulas
       Count(DESCONTO),
...
-- HAVING É FEITO PARA FILTRAR , FUNCIONA COMO UMA CLÁUSULA WHERE PARA COLUNAS QUE FOI USADO FUNÇÕES DE GRUPO
